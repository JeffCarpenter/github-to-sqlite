...
`find` utility or a Python implementation. Pass custom patterns to
`find_build_files()` or use ``--pattern`` with the ``starred-embeddings``
command if you need to search for additional file names.
